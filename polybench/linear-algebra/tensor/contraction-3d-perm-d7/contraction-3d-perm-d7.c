...
#include <string.h>
#include <math.h>
#include "contraction-3d-perm-d7.h"
#include <polybench.h>
...
static
void kernel_contraction_3d_perm_d7(int a_d_1, int a_d_2, int a_d_3,
...
int main(int argc, char** argv)
{
  ...
  /* Run kernel. */
  kernel_contraction_3d_perm_d7(a_d_1, a_d_2, a_d_3,
                           b_d_1, b_d_2, b_d_3,
                           POLYBENCH_ARRAY(C),
                           POLYBENCH_ARRAY(A),
                           POLYBENCH_ARRAY(B));
